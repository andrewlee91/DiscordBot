...
class help:
    ...
    async def help(self, ctx):
        ...
        if ctx.invoked_subcommand is None:
            ...
            embedMessage.add_field(name="Twitter", value="Twitter commands", inline=True)
    ...
    async def basic(self, ctx):
        ...
        embedMessage = discord.Embed(
            ...
            colour=0x87ceeb)
        embedMessage.set_author(name="Basic commands!", icon_url=self.bot.user.avatar_url)
        ...
        embedMessage.add_field(name="roll", value="Roll a dice (d4, d6, d8, d10, d12, d20)", inline=False)
        embedMessage.add_field(name="rps", value="Play Rock, Paper, Scissors", inline=False)
    ...
    async def color(self, ctx):
        ...
        embedMessage = discord.Embed(
            title="All commands use the {} prefix".format(self.bot.command_prefix),
            colour=0x87ceeb)
        embedMessage.set_author(name="Color commands!", icon_url=self.bot.user.avatar_url)
    ...
    async def admin(self, ctx):
        ...
        embedMessage = discord.Embed(
            title="All commands use the {} prefix".format(self.bot.command_prefix),
            colour=0x87ceeb)
        embedMessage.set_author(name="Admin only commands!", icon_url=self.bot.user.avatar_url)
    ...
    async def search(self, ctx):
        ...
        embedMessage = discord.Embed(
            title="All commands use the {} prefix".format(self.bot.command_prefix),
            colour=0x87ceeb)
        embedMessage.set_author(name="Search commands!", icon_url=self.bot.user.avatar_url)
    ...
    async def remindme(self, ctx):
        ...
        embedMessage = discord.Embed(
            title="All commands use the {} prefix".format(self.bot.command_prefix),
            colour=0x87ceeb)
        embedMessage.set_author(name="RemindMe commands!", icon_url=self.bot.user.avatar_url)
    ...
    async def twitter(self, ctx):
        ...
        embedMessage = discord.Embed(
            title="All commands use the {} prefix".format(self.bot.command_prefix),
            colour=0x87ceeb)
        embedMessage.set_author(name="Twitter commands!", icon_url=self.bot.user.avatar_url)

        embedMessage.add_field(name="follow", value="Get updated when someone tweets", inline=False)
